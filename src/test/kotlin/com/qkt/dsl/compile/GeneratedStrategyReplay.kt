...
internal object GeneratedStrategyReplay {
    ...
    fun assertTickBarAndLiveParity(
        ...
        assertThat(barResult.finalPositionsByStrategy)
            .isEqualTo(sourceTickResult.finalPositionsByStrategy)
        assertThat(barResult.accounting).isEqualTo(sourceTickResult.accounting)
        assertThat(barResult.bookRisk).isEqualTo(sourceTickResult.bookRisk)
