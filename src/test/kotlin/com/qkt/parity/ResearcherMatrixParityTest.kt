...
class ResearcherMatrixParityTest {
    ...
    data class Case(
        ...
        /** Tape length. Higher-timeframe cases need enough hours to close 4h bars and cross a day. */
        val hours: Int = 6,
    ) {
    ...
    companion object {
        internal const val A = "BACKTEST:AAA"
        internal const val B = "BACKTEST:BBB"
        ...
        /** One tick a minute per symbol for the case's length: a slow swing with a faster wobble, repeatable. */
        internal fun tape(
            symbols: List<String>,
            minutes: Int,
            startMinute: Int,
