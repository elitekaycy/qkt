...
class ConnectivityArchitectureTest {
    ...
    private val toolAllowList: Map<String, Set<String>> =
        mapOf(
            ...
            "cli/audit/Mt5HistoryAudit.kt" to setOf("mt5"),
            "cli/audit/TradingViewDriftAudit.kt" to setOf("mt5"),
            "cli/BrokersCommand.kt" to setOf("mt5"),
            "cli/FetchCommand.kt" to setOf("mt5", "bybit"),
            "cli/fetch/BarFetcher.kt" to setOf("mt5", "bybit"),
            "cli/fetch/BarFetcherFactory.kt" to setOf("mt5", "bybit"),
